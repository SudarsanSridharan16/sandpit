package com.example.datagrid.projects.domain;
...
public class Trade implements Portable{
    ...
    private TradeTransactionTypeEnum tradeTransactionType = TradeTransactionTypeEnum.NEW;
    private TradeTypeEnum tradeType = TradeTypeEnum.REGULAR_TRADE;
    private TradeTypeEnum secondaryTradeTypeEnum = TradeTypeEnum.WAP_TRADE;
    private DateTime originalTradeDate = new DateTime();
    ...
    ,              price;
    private CurrencyPairEnum currencyPair = CurrencyPairEnum.AUDCAD;
    private Venue executionVenue = new Venue();
    private Instrument instrument = new Instrument();
    // Dimension Ids
    private String  instrumentDimId = "1"
    ,               executionVenueDimId = "1"
    ,               counterPartyDimId = "1";
    ...
    public void writePortable(PortableWriter out) throws IOException {
        ...
        out.writePortable("instrument", instrument);
    ...
    public void readPortable(PortableReader in) throws IOException {
        ...
        this.instrument = in.readPortable("instrument");
